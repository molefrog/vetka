...
export default function ReposPage() {
  ...
  async function signOut() {
    const sessions = listStoredSessions();
    for (const did of sessions) deleteStoredSession(did as Did);
    router.replace("/");
  }
            ...
            <div className="space-y-2">
              {repos.map((repo) => (
                <div
                  ...
                  onClick={() =>
                    setSelectedRepo(selectedRepo?.uri === repo.uri ? null : repo)
                  }
                >
                    ...
                    <div className="mt-3 pt-3 border-t border-zinc-100">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            navigator.clipboard.writeText(repo.sshUrl);
                          }}
